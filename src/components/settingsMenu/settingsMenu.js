...
export default function SettingsMenu({ onReset }) {
  ...
  return (
    <div ref={menuRef} className='relative inline-block'>
      ...
      {open && (
        <div className='absolute right-0 mt-2 w-60 origin-top-right rounded-2xl bg-white dark:bg-[#1C1C1E] shadow-xl ring-1 ring-black/5 focus:outline-none p-2 animate-fade-in z-50'>
          <button
