...
export default function Celebration({
  ...
  const baseButtonStyle = "text-text bg-background border-2 border-current rounded hover:bg-[green] hover:text-white transition-colors duration-200";
    ...
    <div className='celebration-container'>
      <div className='fixed top-[30%] left-1/2 -translate-x-1/2 z-[250] text-[#00ffff] text-[3rem] w-full bg-[#000000cc] animate-fade p-4'>
        <p ref={highScoreRef} className="my-2">
          Highscore achieved: <span className="text-[#adff2f] text-[4rem] align-middle">{highScore}</span>
          <br />
        </p>
        {
          <p>
